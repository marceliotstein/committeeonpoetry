...
<section id="content" role="main">
  <div class="cop-theater-narrow">
    <table class="cop-table-narrow">
      <tr>
        <td class="cop-right-narrow">
          <div class="cop-main">
            <div class="mission">
      ...
      <tr>
        <td class="cop-left-narrow">
          <div class="cop-insta-narrow">
            <?php echo do_shortcode("[instagram-feed]") ?>
          </div>
          <div class="cop-deco">
            <img class="cop-image cop-left-image-narrow" src="/wp/wp-content/themes/blankslate-child/images/cvpond500.jpg" />
          </div>
        </td>
      </tr>
    </table>
    ...
    <table class="cop-table-wide">
      <tr>
        <td class="cop-left-wide">
          ...
          <div class="cop-deco">
            <img class="cop-image cop-left-image-wide" src="/wp/wp-content/themes/blankslate-child/images/cvpond500.jpg" />
          </div>
        </td>
